...
model = ''; % compare to savePrefix in Sim_depANOVA_Generic. Other examples 'S_subjInt_50' or 'S_subjInt_100_AS' etc.

effect = {'spurInt'}; % 'mainInt', 'spurInt', 'confMain' or 'onlyMain'
