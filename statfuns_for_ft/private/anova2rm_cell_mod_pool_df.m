function [fA, fB, fAB, dfApair, dfBpair, dfABpair] = anova2rm_cell_mod_pool_df(data)
...
% Adapted by Saskia Helbling%  anova2rm_cell() - compute F-values in cell array using repeated measurement ANOVA.
...
A = sum(AB,3); % sum across columns, so result is ax1 column vect
